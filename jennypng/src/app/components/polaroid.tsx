...
export default function Polaroid({ imageSrc, altText, caption }: { imageSrc: string; altText: string; caption?: string }) {
    return (
        <div className="bg-white flex-shrink-0 p-4 pb-8 shadow-lg -rotate-1 transition-transform duration-300 hover:rotate-0 hover:scale-105 hover:animate-[jiggle_0.6s_ease-in-out_forwards] w-[340px] h-[470px]">
